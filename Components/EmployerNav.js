  ...
  return (
    ...
    <Container fluid>
        ...
        <Row className={styles['candidateNav']}>
            <Col xs={3}>
                 <Nav.Link as={Link} href='/users/employer/user-employer'>Dashboard</Nav.Link>
            </Col>
            <Col xs={3}>
              <Nav.Link as={Link} href='/home/submit-job-order'>Job Order</Nav.Link>
            </Col>
            <Col xs={3}>
              <Nav.Link as={Link} href='/users/candidate/user-candidate'>My Jobs</Nav.Link>
            </Col>  
            <Col xs={3}>
              <Nav.Link as={Link} href='/users/candidate/user-candidate'>Applicants</Nav.Link>
            </Col>  
        </Row>
        <Row className={styles['navbar-sign-container']}>
        <Dropdown >
                <Dropdown.Toggle className='toggleIcons'  variant='' >
                    <PersonIcon style={{backgroundColor:"#e4e3e3",color:"#25CED1",borderRadius:"50%",marginBottom:"7px"}} sx={{fontSize:50}}/> <p>Employer</p> 
                </Dropdown.Toggle>
